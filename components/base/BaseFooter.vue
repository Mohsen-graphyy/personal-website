<template>
  <footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 pb-8 pt-14 mx-auto">
      <div class="flex flex-col items-center text-center">
        <div class="flex items-center">
          <img
            class="w-10"
            src="/personal-website/images/perp-MP-logo.png"
            alt="Mohsen piri"
          />
          <p class="text-violet-600 font-semibold pl-5 text-xl">Mohsen Piri</p>
        </div>
        ...
        >
          ...
          <button
            class="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-violet-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-violet-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
          >
            Get started
          </button>
        </div>
